...
var githubRepository = "SushiHangover.Android.Maps.Utils";
var githubUrl = string.Format("https://github.com/{0}/{1}", githubOwner, githubRepository);

var isRunningOnAppVeyor = AppVeyor.IsRunningOnAppVeyor;
var isPullRequest = AppVeyor.Environment.PullRequest.IsPullRequest;
var isRepository = StringComparer.OrdinalIgnoreCase.Equals("sushihangover/SushiHangover.Android.Maps.Utils", AppVeyor.Environment.Repository.Name);
...
var packageWhitelist = new[] { "SushiHangover.Android.Maps.Utils" };
...
Action<string, string> Package = (nuspec, basePath) =>
{
    ...
    NuGetPack(nuspec, new NuGetPackSettings {
        ...
        IconUrl                  = new Uri("https://raw.githubusercontent.com/sushihangover/SushiHangover.Android.Maps.Utils/master/media/icon.png"),
        LicenseUrl               = new Uri("https://github.com/SushiHangover.Android.Maps.Utils"),
        Copyright                = "Copyright (c) SushiHangover/RobertN",
        RequireLicenseAcceptance = false,

        Version                  = nugetVersion,
        Tags                     = new [] {  "Xamarin", "Android", "Google", "Map", "SushiHangover" },
...
Setup((context) =>
{
    Information("Building version {0} of SushiHangover.Android.Maps.Utils. (isTagged: {1})", informationalVersion, isTagged);
});
    ...
    .Does (() =>
{
    ...
    build("SushiHangover.Android.Maps.Utils.sln");
});
...
{
    RestorePackages("./src/SushiHangover.Android.Maps.Utils.sln");
});
